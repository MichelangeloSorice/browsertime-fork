...
module.exports.configureBuilder = function(builder, baseDir, options) {
  ...
  // My personal stupi additions to set chrome profile
  // chromeOptions.addExtensions(
  //   path.resolve(moduleRootPath, 'vendor', 'uBlock-Origin_v1.16.18.crx')
  // );
  // chromeOptions.addExtensions(
  //   path.resolve(moduleRootPath, 'vendor', 'No-Script-Suite-Lite_v0.2.9.crx')
  // );
