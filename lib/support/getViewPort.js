...
// Adopting default viewPort of 1920x1080, values are increased as the screenshot tool of the driver
// Usually generates images 8px smaller in width and 85px smaller in height
const DEFAULT_VIEWPORT = '1928x1165';
